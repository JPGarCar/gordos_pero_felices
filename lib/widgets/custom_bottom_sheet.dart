...
/// This code has been copied from the material design bottom sheet, it has the
/// following changes:
/// - Removed the removal of MediaQuery padding and added a SafeArea around everything
/// - changed the max height if scrollable is true to be max * 19.5/20.0
/// - increased the duration of the sheet's enter and exit
